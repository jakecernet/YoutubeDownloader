...
function downloadAudio() {
	...
	fetch(`/download/audio?url=${encodeURIComponent(urlInput)}`)
		...
		.catch((error) => {
			...
			audioMessageElement.innerHTML =
				"<p>An error occurred while downloading the audio. Please try again.</p>";
...
function downloadVideo() {
	...
	fetch(`/download?url=${encodeURIComponent(urlInput)}`)
		...
		.catch((error) => {
			...
			// Display error message
			videoMessageElement.innerHTML =
				"<p>An error occurred while downloading the video. Please try again.</p>";

			// Hide download links and thumbnail in case of an error
			videoLinkElement.style.display = audioLinkElement.style.display =
				"none";
